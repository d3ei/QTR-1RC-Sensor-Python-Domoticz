...
domoticz_port="8080"
dummy_idx={'counter': 89, 'switch':90} # les numéros de devices attribués par Domoticz: un compteur incrémental pour la conso et un interrupteur virtuel pour le détail
IRPIN = 18 # branché sur la GPIO18
HIGH_LEVEL = 0.00017 # niveau de declenchement haut
LOW_LEVEL = 0.00013 # niveau de declenchement bas entre haut et bas il ne se passe rien :/
VOLUME_INC = 1 # 1 = 10 litres, allez demander à Domoticz pourquoi ;)
TIME_INTERVAL = 0.7 # temps entre deux interrogations du capteur, dépend de la vitesse de la roue du compteur
...
SCRIPT_NAME = 'compteurGaz' # nom de votre script sans l'extension .py
#
#
#
